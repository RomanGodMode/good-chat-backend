...
from chat.views import MyDialogsView, CreateChatGroupView, ChatsListView, DetailDialogView, InitiateDialogView, CreatedGroupsView
...
urlpatterns = [
    ...
    path('created-groups/', CreatedGroupsView.as_view())
